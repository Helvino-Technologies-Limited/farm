...
const READ: Record<Role, ModuleKey[]> = {
  ...
  ACCOUNTANT: ["dashboard", "payments", "expenses", "credit", "cash", "reports", "invoices", "customers"],
  PRODUCTION: ["dashboard", "poultry", "inventory"],
  POULTRY: ["dashboard", "poultry"],
  STOREKEEPER: ["dashboard", "inventory", "products"],
  PROCUREMENT: ["dashboard", "inventory", "products"],
...
const WRITE: Record<Role, ModuleKey[]> = {
  ...
  MANAGER: [
    ...
    "sales", "invoices", "payments", "inventory", "expenses", "cash",
  ],
