  ...
  return (
    <div className="flex flex-col">
      <section className="relative overflow-hidden bg-avepo-green text-white">
        {settings?.servicesVideoUrl && <HeroBackgroundVideo url={settings.servicesVideoUrl} />}
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 sm:py-28">
          <p className="text-base font-semibold uppercase tracking-wider text-avepo-yellow-light">Our Services</p>
          <h1 className="mt-2 text-4xl font-bold sm:text-5xl">More than just products</h1>
          <p className="mt-4 max-w-2xl text-lg text-white/85">
            Alongside our produce and poultry, we offer agricultural services to support your own farm — book
            online and we&apos;ll be in touch to confirm details.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h2 className={serviceEntries.length > 0 ? "mt-14 text-3xl font-bold" : "text-3xl font-bold"}>Book a service</h2>
